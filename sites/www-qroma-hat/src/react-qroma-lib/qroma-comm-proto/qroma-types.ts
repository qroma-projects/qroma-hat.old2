...
export interface FirmwareDetails {
    ...
    appVersion: string;
    /**
     * @generated from protobuf field: string libVersion = 3;
     */
    libVersion: string;
}
/**
...
class FirmwareDetails$Type extends MessageType<FirmwareDetails> {
    constructor() {
        super("FirmwareDetails", [
            ...
            { no: 3, name: "libVersion", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value?: PartialMessage<FirmwareDetails>): FirmwareDetails {
        const message = { buildTime: "", appVersion: "", libVersion: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string appVersion */ 2:
                    ...
                    break;
                case /* string libVersion */ 3:
                    message.libVersion = reader.string();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: FirmwareDetails, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* string libVersion = 3; */
        if (message.libVersion !== "")
            writer.tag(3, WireType.LengthDelimited).string(message.libVersion);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
